...
def remainder():
    ...
    # индикатор выполнения --> выведется сообщения об ошибке --> прерывается функция --remainder()--.
...
if __name__ == "__main__":
    print("--| remainder.py |-- was launched.")

else:
    print("--| remainder.py |-- was imported.")
