...
def difference():
    ...
    # индикатор выполнения --> выведется сообщения об ошибке --> прерывается функция --difference()--.
...
if __name__ == "__main__":
    print("--| difference.py |-- was launched.")

else:
    print("--| difference.py |-- was imported.")
