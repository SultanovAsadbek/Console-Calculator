...
def multiplication():
    ...
    # индикатор выполнения --> выведется сообщения об ошибке --> прерывается функция --multiplication()--.
...
if __name__ == "__main__":
    print("--| multiplication.py |-- was launched.")

else:
    print("--| multiplication.py|-- was imported")
