...
def integer_division():
    ...
    # индикатор выполнения --> выведется сообщения об ошибке --> прерывается функция --integer_division()--.
    ...
    decision = round(float(value_1) // float(value_2))
...
if __name__ == "__main__":
    print("--| integer_division.py |-- was launched.")

else:
    print("--|integer_division.py|-- was imported.")
