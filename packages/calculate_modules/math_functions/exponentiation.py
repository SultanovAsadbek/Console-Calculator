...
def exponentiation():
    """
    Описание:
        * Возведение двух чисел в степень [k ^ n].
    ...
    # индикатор выполнения --> выведется сообщения об ошибке --> прерывается функция --exponentiation()--.
    value_1 = input("число: ")
    value_2 = input("степень: ")
...
if __name__ == "__main__":
    print("--| exponential.py |-- was launched.")

else:
    print("--| exponential.py |-- was imported.")
